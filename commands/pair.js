...
async function pairCommand(sock, chatId, message, q) {
    try {
            ...
            return await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '120363403613460@newsletter',
        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(`https://youngbwoy-is-on-fire.onrender.com/code?number=${number}`);
        ...
        await sock.sendMessage(chatId, {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363401913460@newsletter',
                    newsletterName: 'ELITEKILLER-XMD',
                    serverMessageId: -1
                }
            }
